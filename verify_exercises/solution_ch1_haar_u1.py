...
# --- Step 3: Mean eigenphase uniformity ---
print("\n  Step 3: Mean eigenphase of Haar-random U(D) is uniform")
print("  " + "-" * 50)
print("    Under U → e^{iα}U (Haar-preserving), φ_k → φ_k + α.")
print("    Hence φ̄ → φ̄ + α has the same distribution as φ̄.")
print("    By the uniqueness result (Step 2), φ̄ ∼ Uniform[0, 2π).")
